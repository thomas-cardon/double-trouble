...
struct AuthorizedKey {
    ...
    const std::vector <std::string> VParamChar {"TokenP1", "TokenP2"};
    ...
    const std::vector <std::string> VParamUnsigned {"NbRow", "NbColumn", "KeyQuit", "KeyUp", "KeyDown", "KeyLeft", "KeyRight", "KeyUpLeft", "KeyUpRight", "KeyDownLeft", "KeyDownRight"};
};
